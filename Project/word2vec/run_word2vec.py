...
if __name__ == '__main__':
    ...
    word2vec_model_path = "w2v_model/word2vec.model"
    keyvector_save_path = "w2v_model/word2vec.kv"

    print("Merging csv...")
    csv_reader.clean_csv("../unlabeled_dataset",
                         "merged_file.csv", ignore_list)
